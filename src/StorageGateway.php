...
use Medusa\StorageGateway\Exception\StorageGatewayException;
...
class StorageGateway
{
    ...
    public static function get(string $alias, $parameters)
    {
        ...
        if ($response->getStatusCode() === 500) {
            throw new StorageGatewayException(
                'REMOTE EXCEPTION: ' .
            ...
            throw new StorageGatewayException($response->getStatusCode() . ' ' . $response->getReasonPhrase());
        }
